...
function Skills(props){
    ...
    return (
      <div className="Skills_skills">
        ...
        <SkillBar skill="Formik" competence="60" tooltip={tooltips.formik}/>
        <SkillBar skill="Axios" competence="70" tooltip={tooltips.axios}/>

        <SkillTitle title="Back End" />
        <SkillBar skill="SQL Server" competence="60" tooltip={tooltips.sqlServer}/>
        <SkillBar skill=".Net Core" competence="60" tooltip={tooltips.netCore}/>
        <SkillBar skill="C#" competence="50" tooltip={tooltips.cSharp}/>
        <SkillBar skill="Postman" competence="50" tooltip={tooltips.postman}/>

        <SkillTitle title="Technologies" />
        <SkillBar skill="VS Code" competence="80" tooltip={tooltips.vsCode}/>
        <SkillBar skill="Visual Studio" competence="60" tooltip={tooltips.visualStudio}/>
